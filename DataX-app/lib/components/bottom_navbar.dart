...
class DataXNavbar extends ConsumerStatefulWidget {
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _DataXNavbarState();
}

class _DataXNavbarState extends ConsumerState<DataXNavbar> {
  @override
