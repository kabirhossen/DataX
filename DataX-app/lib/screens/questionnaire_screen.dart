...
import 'package:DataX/model/question.dart';
import 'package:DataX/providers/feeling_provider.dart';
import 'package:DataX/providers/questionnaire_provider.dart';
import 'package:DataX/screens/connect_data.dart';
import 'package:DataX/screens/main_screen.dart';
import 'package:DataX/screens/journal_screen.dart';
...
class _QuestionnaireScreenState extends ConsumerState<QuestionnaireScreen> {
  ...
  Future<void> GetData() async {
    ...
    var url = Uri.parse(
        'https://DataX-tron-s4-api.onrender.com/api/GET/Trial/Survey/GetSurveyDetails?surveyid=${surveyid}');
  ...
  Future<void> SaveData(sectionindex) async {
    ...
    var url = Uri.parse(
        'https://DataX-tron-s4-api.onrender.com/api/POST/Trial/Survey/CreateSurveyAnswers');
  ...
  Future<void> FinishSurvey() async {
    ...
    var url = Uri.parse(
        'https://DataX-tron-s4-api.onrender.com/api/POST/Trial/Survey/CreateCompletedSurvey');
