...
import 'package:DataX/components/register_modal.dart';
import 'package:DataX/screens/get_ready.dart';
...
class AuthScreenApp extends State<AuthScreen> {
  ...
  Future<void> LoginAccount() async {
    var url =
        Uri.parse('https://DataX-tron-s4-api.onrender.com/api/POST/Login');
