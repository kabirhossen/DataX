...
import 'package:DataX/components/bottom_navbar.dart';
import 'package:DataX/model/offer.dart';
import 'package:DataX/model/trial.dart';
import 'package:DataX/model/trial_action.dart';
import 'package:DataX/providers/navbar_provider.dart';
import 'package:DataX/screens/qr_code_generated.dart';
import 'package:DataX/screens/wearables_screen.dart';
import 'package:DataX/screens/auth_screen.dart';
import 'package:DataX/screens/feeling_screen.dart';
...
class _MainScreenState extends ConsumerState<MainScreen> {
  ...
  Future<void> GetAvialbleData() async {
    avilableTrials = [];
    var url = Uri.parse(
        'https://DataX-tron-s4-api.onrender.com/api/GET/Trial/GetAvailableTrial?userid=${userid}');
  ...
  Future<void> GetOngoingData() async {
    ...
    dummyActions = [];
    var url = Uri.parse(
        'https://DataX-tron-s4-api.onrender.com/api/GET/Trial/GetOngoingTrial?userid=${userid}');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
  ...
  Future<void> GetFHIRData(int userid) async {
    ...
    var urlFH = Uri.parse(
        'https://DataX-tron-s4-api.onrender.com/api/GET/getFhir?userid=${int.parse(userid.toString())}');
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> StartTrial(int trialid) async {
      ...
      var url = Uri.parse(
          'https://DataX-tron-s4-api.onrender.com/api/POST/Trial/CreateOngoingTrail');
    ...
    void UpdateImage() async {
      ...
      int userid = int.parse(prefs.getString("userid").toString());
      var url = Uri.parse(
          'https://DataX-tron-s4-api.onrender.com/api/POST/UpadateImage');
      await http.post(url, headers: POSTheader, body: {
        'userid': userid.toString(),
    ...
    return Scaffold(
      bottomNavigationBar: DataXNavbar(),
      body: IndexedStack(
